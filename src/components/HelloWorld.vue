<template>
  <div class="hello">
    ...
    <div>
      <h3>Values</h3>
      <p>
        * Building products beautiful inside &#38; out
        <br />
    ...
    <div>
      <h3>Faves</h3>
      <p>
        * Taking tons of photographs &#38; never sharing
        <br />
        * Reading &#38; complaining about urban planning
        <br />
        * Exploring cities &#38; spending time in nature
        <br />
